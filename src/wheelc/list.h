 ...
 */
void __list_add(struct list_head *new_var,
 ...
 */
void list_add(struct list_head *new_var, struct list_head *head);
 ...
 */
void list_add_tail(struct list_head *new_var, struct list_head *head);
 ...
 */
void hlist_move_list(struct hlist_head *old, struct hlist_head *new_var);
